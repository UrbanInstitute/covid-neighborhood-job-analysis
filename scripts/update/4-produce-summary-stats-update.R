...
create_tmax_histogram <- function(data, group, title) {
  ...
  ggplot() + 
    ...
    geom_vline(xintercept = tmax_bins, 
               linetype = "dashed",
               color = palette_urbn_magenta[5]) +
    geom_text(mapping = aes(x = lines,
                            y = 0,
                            label = lines_chr,
                            hjust = 1,
                            vjust = 1, 
...
put_object(paste0(s3_filepath, "summary_stats/max_cbsa_industry_hist_zoomed.png"),
           "summary_stats/max_cbsa_industry_hist_zoomed.png",
           my_bucket_name)

put_object(paste0(s3_filepath, "summary_stats/max_county_industry_hist_zoomed.png"),
           "summary_stats/max_county_industry_hist_zoomed.png",
           my_bucket_name)

put_object(paste0(s3_filepath, "summary_stats/max_cbsa_industry_hist.png"),
           "summary_stats/max_cbsa_industry_hist.png",
           my_bucket_name)

put_object(paste0(s3_filepath, "summary_stats/max_county_industry_hist.png"),
           "summary_stats/max_county_industry_hist.png",
           my_bucket_name)

put_object(paste0(s3_filepath, "summary_stats/tmax_cbsa_hist.png"),
           "summary_stats/tmax_cbsa_hist.png",
           my_bucket_name)

put_object(paste0(s3_filepath, "summary_stats/tmax_county_hist.png"),
